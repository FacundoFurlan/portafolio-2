...
export default function Home() {
  ...
  return (
    <div className="grid py-6 bg-zinc-800 xl:ml-[25%] min-h-[100vh]">
      ...
      <Proyects name="🛰️ Nexus" link="#" github="https://github.com/NeroWork/Nexus" img="/nexus.png" description="E-commerce Web Page. It follows the design pattern of the most used platforms for buying and selling electronic devises. Since it's a big project, it's still in proccess, so most of the functions will be working in the future." tags={["In progress","NextJS", "React", "MongoDB"]}></Proyects>
    </div>
  );
}
