    ...
    return (
        <div className="flex flex-col align-center mx-10">
            ...
            <div className="flex flex-col mb-5">
                ...
                <div className="mb-2 mx-3">You can find me on any of my social media channels, but if you&apos;d like a quick response, feel free to email me anytime.</div>
                <div className="text-xl">🧩​ Can you show us some of your projects?</div>
